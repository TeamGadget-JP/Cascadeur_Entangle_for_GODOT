...
5. GODOTのタイムラインを動かすとキャラクターがストロボ現象を起こします -> これは異常ではありません。<br>
 これはGODOTに限らずほぼ全てのソフトで起こる現象でタイムラインが持つアセットへの影響力が上位にある事で起こります。<br>
...
8. もし、同期を開始時にキャラクターが崩れたら... -> リグ・アグノスティック機能が通らなかった事を意味します。<br>
 CEGの今回のバージョンには手動調整機能は実装しませんでしたので、このケースが起こった場合はキャラクターの<br>
 制作過程に戻り、もう一度ボーンの向き等を見直して貰う他に手立てはありません。<br>
